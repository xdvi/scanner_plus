...
class ScannerPlusIos extends ScannerPlusPlatform {
  static const MethodChannel _channel = MethodChannel('scanner_plus_ios');

  /// Registers this class as the default instance of [ScannerPlusPlatform].
  static void registerWith() {
    ScannerPlusPlatform.instance = ScannerPlusIos();
    api.RustLib.init();
  }
  ...
  ScannerPlusCameraStream startScan(ScannerPlusCamera camera, {ScannerPlusOptions? options}) {
    // Return Rust scan by default as the stream.
    // The native preview is handled by buildPreview.
  ...
  Widget buildPreview(void Function(ScannerPlusCapture) onCapture) {
    return UiKitView(
      ...
      onPlatformViewCreated: (id) {
        final channel = EventChannel('scanner_plus_ios/barcodes/$id');
